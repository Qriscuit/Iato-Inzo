...
public class Movement : MonoBehaviour
{
    ...
    private void Jump()
    {
        if (Controller.isGrounded)
        {
            ...
            Animator.speed = -2 * (JumpVelocity / Gravity);
            ...
            {
                DistanceToKeepInMind = Vector3.Distance(transform.position, HitInfo.point);
            }

            StartCoroutine(CheckDistanceFromFloor());
        }
    }

    IEnumerator CheckDistanceFromFloor()
    {
